...
TRIAL=v2_dti4_wb_18_LS_2mm_biased_augmented005
...
/home/aizenberg/dgellis/.conda/envs/pytorch-1.6/bin/python /home/aizenberg/dgellis/fCNN/scripts/set_model_bias.py ${OLD_MODEL} ${CONFIG} ${BIAS} ${MODEL}
/home/aizenberg/dgellis/.conda/envs/pytorch-1.6/bin/python /home/aizenberg/dgellis/fCNN/trials/run_trial.py ${CONFIG} ${MODEL} ${LOG} ${HCC_CONFIG} ${BIAS}
