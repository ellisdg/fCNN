...
def main():
    ...
    output_filename = "/work/aizenberg/dgellis/fCNN/{}_{}_average_tfMRI_ALL_level2_zstat_hp200_s2_TAVOR.nii.gz".format(namespace.group,
                                                                                                                       os.path.basename(namespace.config_filename).split(".")[0])

    if namespace.overwrite or not os.path.exists(output_filename):
        ...
        new_image.to_filename(output_filename)
